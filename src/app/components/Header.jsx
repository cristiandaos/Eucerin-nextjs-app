...
const Header = () => {
  ...
  return (
    <header className="relative z-50 flex items-center justify-between px-6 py-2 bg-white shadow">
      <div className="flex items-center space-x-6">
        <a href="/" aria-label="Inicio">
          ...
          >
            <path
              d="M149.607 46.524 80.582 63 11.566 46.524h138.041Z"
              fill="#A70532"
            ></path>
            <path
      ...
      <div className="flex items-center space-x-4">
        ...
        <a
          href="/test"
          className="hidden md:inline-block bg-red-800 hover:bg-red-700 text-white text-s px-4 py-2 rounded cursor-pointer"
        >
          Iniciar test
        </a>
      ...
      {/* Menú móvil */}
      {isMenuOpen && (
        <div className="md:hidden absolute top-20 left-0 right-0 bg-white shadow-lg flex flex-col items-center space-y-4 py-4 z-50">
          ...
          <a
            href="/test"
            className="bg-red-800 hover:bg-red-700 text-white text-s px-4 py-2 rounded cursor-pointer"
          >
            Iniciar test
          </a>
          {user && (
